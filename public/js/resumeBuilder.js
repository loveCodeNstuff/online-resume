...
var bio = {
  ...
  "biopic": "/img/pic.png",
  "heroPics": ["img/bg-lg.png", "img/bg-md.png", "img/bg-sm.png"],
  "display": function display() {
    ...
    if (bio.skills.length !== 0) {
      ...
      for (var x = 0; x < bio.skills.length; x++) {
        ...
        var skillEntry = '<div class="col-md-3 col-xs-12 text-center">' + ("<h3>" + bio.skills[x] + "</h3>") + ("<img src=" + bio.skillsPics[x] + " class='img-responsive' alt='pictures of web icons'>") + '</div>';
...
var projects = {
  ...
  "display": function display() {
    ...
    $('#projectsTitle').append("<div class=\"col-md-12 text-center\">" + "<h1>Projects</h1>" + "</div>");
